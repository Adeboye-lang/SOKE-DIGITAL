        ...
        <section className="py-24 bg-white px-8 md:px-16 lg:px-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {cards.map((card, index) => (
                    <div key={index} className="relative h-64 rounded-xl overflow-hidden group hover:shadow-xl transition-all duration-300 border-b-4 border-transparent hover:border-blue-500">
