...
const BlogPost: React.FC = () => {
    ...
    if (loading) {
        return (
            <PageTransition>
                <SEOHead title="Loading Post..." description="Fetching blog post details." />
    ...
    if (!post) {
        return (
            <PageTransition>
                <SEOHead title="Post Not Found" description="The blog post you are looking for does not exist." />
                <div className="min-h-screen bg-white pt-24 pb-16 flex items-center justify-center">
    ...
    return (
        <PageTransition>
            <SEOHead
                ...
                ogType="article"
            />
            <article className="bg-[#fefdfb] min-h-screen relative selection:bg-blue-100 selection:text-blue-900 pb-32">
                {/* Header / Hero */}
