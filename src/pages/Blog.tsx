            ...
            <div className="bg-white min-h-screen relative font-sans selection:bg-blue-100">
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 min-h-[600px]">
                    ...
                    <motion.div
                        ...
                        className="mt-32 bg-slate-950 rounded-2xl p-12 md:p-16 text-center text-white relative overflow-hidden"
                    >
                        ...
                        <div className="relative z-10 max-w-2xl mx-auto">
                            ...
                            <div className="flex gap-2 max-w-md mx-auto">
                                ...
                                <button className="bg-white text-slate-950 px-6 py-3 rounded-lg font-bold hover:bg-blue-50 transition-colors">Subscribe</button>
                            </div>
                        </div>
                    </motion.div>
                </div>
