...
// Move interfaces outside component body
interface Project {
    id: string;
    title: string;
    category: string;
    ...
    const DEFAULT_PROJECTS: Project[] = [
        {
            ...
            category: 'Fintech',
            imageUrl: '/ura.jpeg',
            description: 'A comprehensive brand identity and digital presence for a forward-thinking financial institution.',
            client: 'Ura Financial Services',
            content: ''
        },
        {
            id: '2',
            ...
            description: 'Brand strategy and visual identity for a premium culinary experience.',
            client: 'Chef Ima',
            content: ''
        },
        {
            ...
            description: 'Digital transformation and e-commerce platform for a sustainable lifestyle brand.',
            client: 'Puradia',
            content: ''
        }
    ];
