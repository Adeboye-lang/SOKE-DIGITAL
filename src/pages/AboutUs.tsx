...
const AboutUs: React.FC = () => {
    return (
        <PageTransition>
            <SEOHead
                title="About Us | Our Manifesto & Team"
                description="We are a collective of strategists, operators, and creatives building the foundations that allow African businesses to scale globally."
