            ...
            <PageTransition>
                <div className="min-h-screen bg-white pt-24 pb-16 flex items-center justify-center">
                    <div className="text-center">
                        ...
                        <p className="text-slate-600">The portfolio project you're looking for doesn't exist.</p>
                        <Link to="/our-portfolio" className="mt-4 inline-block text-blue-600 hover:underline">← Back to Portfolio</Link>
                    </div>
                </div>
            </PageTransition>
        );
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
                        ...
                        <div className="md:col-span-4 space-y-8">
                            ...
                            <div>
                                <h3 className="text-white font-bold uppercase tracking-widest text-base mb-3 border-b border-gray-700 pb-1">Description</h3>
